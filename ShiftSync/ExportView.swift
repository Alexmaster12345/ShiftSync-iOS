...
struct ExportView: View {
    ...
    private func exportPDF() {
        ...
        let data = renderer.pdfData { ctx in
            ...
            y = pageH - margin
            drawText(
                "This report is a personal record generated by the employee and does not constitute an official payslip or legal document.",
                x: margin, y: y - 32, font: .systemFont(ofSize: 7.5), color: .gray, maxWidth: pageW - margin
            )
