...
struct ProfileView: View {
        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                settingsSection(title: "PAY SETTINGS") {
                    ...
                    VStack(spacing: 0) {
                        HStack(spacing: 12) {
                            settingIcon("dollarsign.circle", color: .greenAccent)
                    ...
                    // Payment type
                    HStack(spacing: 12) {
                        settingIcon("calendar.badge.clock", color: .shiftBlue)
                        Text("Payment").font(.system(size: 15)).foregroundColor(.ssTextPrimary)
                        Spacer()
                    ...
                    // Rate
                    HStack(spacing: 12) {
                        settingIcon("banknote", color: .greenAccent)
                    ...
                    // Work day hours
                    HStack(spacing: 12) {
                        settingIcon("clock.fill", color: .tealAccent)
                ...
                settingsSection(title: "VACATION") {
                    HStack(spacing: 12) {
                        settingIcon("sun.max.fill", color: .tealAccent)
                        VStack(alignment: .leading, spacing: 2) {
    ...
    private func navRow(icon: String, label: String, color: Color, destination: AnyView) -> some View {
